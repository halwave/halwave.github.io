...
const JourneyPage: React.FC = () => (
  <section className="relative z-10 max-w-3xl mx-auto px-2 sm:px-4 py-12 min-h-screen w-full bg-gradient-to-br from-[#1a0033] via-[#2d006e] to-[#3a006e] text-white font-mono overflow-hidden rounded-3xl shadow-2xl border-2 border-pink-400/80">
