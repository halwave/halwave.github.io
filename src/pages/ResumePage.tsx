...
const ResumePage: React.FC = () => (
  <Section title="Resume">
    <div className="text-pink-100">
      ...
      <div className="mt-8">
        <h3 className="text-2xl font-bold text-pink-200 mb-4 border-b border-pink-200 pb-1">Technical Skills</h3>
            ...
            <div key={skill.category} className="bg-[#2d006e]/80 rounded-2xl shadow p-6 border border-pink-400">
              ...
              <ul className="flex flex-wrap gap-2 justify-center">
                {skill.items.map((item) => (
                  <li key={item} className="bg-pink-700/30 px-3 py-1 rounded-full text-sm font-mono border border-pink-300/40">
                    {item}
                  </li>
                ))}
              </ul>
      ...
      <div className="mt-12">
        <h3 className="text-2xl font-bold text-pink-200 mb-4 border-b border-pink-200 pb-1">Professional Experience</h3>
      ...
      <div className="mt-12">
        <h3 className="text-2xl font-bold text-pink-200 mb-4 border-b border-pink-200 pb-1">Education</h3>
        <div className="space-y-4">
          {education.map((edu) => (
      ...
      <div className="mt-12">
        <h3 className="text-2xl font-bold text-pink-200 mb-4 border-b border-pink-200 pb-1">Awards & Certificates</h3>
        <div className="space-y-4">
          {awards.map((award) => (
